...
namespace Sogas
{
	...
	public:
		...
		void setOrthographicSize(f32 size) { m_orthographicSize = size; }
		f32& getOrthographicFar() { return m_orthographicFar; }
		void setOrthographicFar(f32 far) { m_orthographicFar = far; }
		f32& getOrthographicNear() { return m_orthographicNear; }
		void setOrthographicNear(f32 near) { m_orthographicNear = near; }

		// Perspective function
		f32 getPerspectiveFOV() { return m_perspectiveFOV; }
		void setPerspectiveFOV(f32 fov) { m_perspectiveFOV = fov; }
		f32 getPerspectiveNear() { return m_perspectiveNear; }
		void setPerspectiveNear(f32 near) { m_perspectiveNear = near; }
		f32 getPerspectiveFar() { return m_perspectiveFar; }
		void setPerspectiveFar(f32 far) { m_perspectiveFar = far; }
	private:
